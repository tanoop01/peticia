        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 hover:opacity-90 transition-opacity group"
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform bg-[#EA4335]">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 hover:opacity-90 transition-opacity group"
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform bg-[#25D366]">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 hover:opacity-90 transition-opacity group"
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform bg-[#000000]">
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 p-3 hover:opacity-90 transition-opacity group"
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform bg-[#1877F2]">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* <button
              ...
              className="flex flex-col items-center gap-2 p-3 hover:opacity-90 transition-opacity group"
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform bg-[#00AA33]">
