 ...
 * 
 * This script populates the legal_documents table with common Indian laws
 * that citizens frequently need to know about.
 * 
 * Usage:
  ...
  for (const doc of LEGAL_DOCUMENTS) {
    try {
      ...
      if (!response.ok) {
        ...
        console.log(`   ✅ Success (ID: ${result.document.id})`);
        successCount++;
      }
...
export { seedDocuments, LEGAL_DOCUMENTS };
