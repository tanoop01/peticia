-- ============================================
-- MYKAIRO CIVIC PLATFORM - SEED DATA
-- ============================================
-- Development seed data for local testing
-- This seed file is idempotent where possible
-- 
-- Usage: 
--   supabase db reset  (runs migrations + seed)
--   supabase db seed   (runs seed only)
--
-- WARNING: 
--   - This is for DEVELOPMENT only
--   - Never run this on production
--   - Contains no production secrets or real data
-- ============================================

-- ============================================
-- SAMPLE LEGAL DOCUMENTS
-- ============================================
-- Insert common legal provisions that users frequently need
-- Embeddings will be generated by the application after seed
...
-- DEVELOPMENT NOTES
-- ============================================
-- The following data should be seeded by your application:
-- 
-- 1. Users: Should be created through Firebase Auth + Supabase signup flow
--    - Never seed production user data
--    - Test users should use development Firebase project
--
-- 2. Petitions: Should be created through the application UI
--    - Ensures all business logic is applied correctly
--    - Maintains data integrity with proper validation
--
-- 3. Legal Documents: 
--    - Core legal provisions seeded above
--    - Additional documents via scripts/seed-legal-documents.ts
--    - Embeddings generated via API route after seed
--
-- 4. For local testing:
--    - Use Firebase emulator for auth
--    - Create test users through signup flow
--    - Use application UI to create test petitions
-- ============================================
